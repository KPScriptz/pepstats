...
// timers are individual chips; golddiff/jungle/ult/flash are the P3.4 extras.
const MODULES = ["stats", "skill", "toasts", "golddiff", "jungle", "ult", "flash"];
const mods = {};
...
function defaultLayouts() {
  ...
  return {
    ...
    ult: { x: left, y: 470, scale: 1 },
    flash: { x: left, y: 560, scale: 1 },
  };
}
